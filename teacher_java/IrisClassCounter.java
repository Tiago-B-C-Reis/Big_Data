...
public class IrisClassCounter {
    public static void main(String [] args) throws Exception
    {
        ...
        Job j=new Job(c,"irisclasscounter");
        j.setJarByClass(IrisClassCounter.class);
    ...
    public static class MapForWordCount extends Mapper<LongWritable, Text, Text,
                ...
                IOException, InterruptedException
        {
            ...
            if (fields.length >= 4 && !line.startsWith("sepal"))
            {
                Text outputKey = new Text(fields[4]);
