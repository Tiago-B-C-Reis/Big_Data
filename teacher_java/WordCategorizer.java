...
public class WordCategorizer {
    public static void main(String [] args) throws Exception
    {
        ...
        Job j=new Job(c,"wordcategorizer");
    ...
    public static class MapForWordCount extends Mapper<LongWritable, Text, Text,
                ...
                IOException, InterruptedException
        {
            ...
            for(String word: words )
            {
                ...
                myMap.put(category, myMap.getOrDefault(category, 0) + 1);
            }

            for(String category: myMap.keySet())
            {
                Text outputKey = new Text(category);
                IntWritable outputValue = new IntWritable(myMap.get(category));
        ...
        {
            return word.length() > 2 ? "Big": "Small"; 
        }
    }
